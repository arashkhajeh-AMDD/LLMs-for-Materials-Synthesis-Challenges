...
class LoadConfig:
    ...
    # Retrieve the OpenAI API key from environment variables
        ...
        self.langchain_llm = ChatOpenAI(
            model_name=self.model_name,  # e.g., "gpt-3.5-turbo"
            temperature=self.temperature,
    ...
    # load papers rag config
    def load_rag_config(self, app_config):
        self.collection_name = app_config["paper_rag_configs"]["collection_name"]
        self.top_k = app_config["paper_rag_configs"]["top_k"]
